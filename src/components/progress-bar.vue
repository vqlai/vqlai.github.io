...
<style scoped>
.progress-box p{font-size: 16px;color:#2F2C06;text-align: left;}
.container{height: 12px;margin: 10px 0;background-color: #e8edf2/* #F8F4E3 */;overflow: hidden;border-radius: 4px;box-shadow: 0 8px 17px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);}
